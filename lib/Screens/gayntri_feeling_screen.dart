...
class GayntriFeelingScreen extends StatefulWidget {
  @override
  // ignore: library_private_types_in_public_api
  _GayntriFeelingScreenState createState() => _GayntriFeelingScreenState();
}

class _GayntriFeelingScreenState extends State<GayntriFeelingScreen> {
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage(
                    "assets/Gayntribackki.jpg"), // Replace with your image
                fit: BoxFit.cover,
              ),
            ),
          ),
